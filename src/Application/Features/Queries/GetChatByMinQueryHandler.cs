...
{
    public class GetChatByMinQueryHandler : IRequestHandler<GetChatByMinQuery, IEnumerable<ChatEventResponses>>
    {
        ...
        public async Task<IEnumerable<ChatEventResponses>> Handle(GetChatByMinQuery request, CancellationToken cancellationToken)
        {
